...
export const WonderPOS = [
  { value: "General Retail & Wholesale", label: "General Retail & Wholesale" },
  {
    value: "Pharmacy Retail & Wholesale",
    label: "Pharmacy Retail & Wholesale",
  },
  ...
  {
    value: "Kirana /Grocery Retail & Wholesale",
    label: "Kirana /Grocery Retail & Wholesale",
  },
  { value: "FMCC Distribution", label: "FMCC Distribution" },
  {
    value: "Jewellery Retail & Wholesale",
    label: "Jewellery Retail & Wholesale",
  },
  {
    value: "Hallmarking Centre Software",
    label: "Hallmarking Centre Software",
  },
  { value: "Gas Agency", label: "Gas Agency" },
  {
    value: "Readymade Retail & Wholesale",
    label: "Readymade Retail & Wholesale",
  },
  {
    value: "Textiles Retail & Wholesale",
    label: "Textiles Retail & Wholesale",
  },
  ...
  { value: "Toys & Gift Shop", label: "Toys & Gift Shop" },
...
export const Status = [
  ...
  { value: "Installed Others", label: "Installed Others" },
];
